 ...
 * 		***@RequestArgsConstructor (lombok) => 생성자에서 객체 주소 설정
 ...
 * 		@RestControllerAdvice ==> 선택적 메모리 할당
 * */
public class FoodRestController {
	...
	public ResponseEntity<Map> food_find_vue(@RequestParam(name="column",required = false) String column, 
			@RequestParam(name="ss",required = false) String ss, @RequestParam(name="page",required = false) String page)
	{
		Map map=new HashMap();
		try
		{
